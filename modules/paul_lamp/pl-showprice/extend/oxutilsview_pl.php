 ...
 *
 * influenced by vt Smarty Extension Demo
 ...
 * You should have received a copy of the GNU General Public License along with this program; if not, see <http://www.gnu.org/licenses/>
 */
class oxutilsview_pl extends oxutilsview_pl_parent
{
    /**
    ...
    protected function _fillCommonSmartyProperties($oSmarty)
    {
        ...
        array_unshift($oSmarty->plugins_dir, oxRegistry::getConfig()->getModulesDir() . "/paul_lamp/pl-showprice/smarty/");
    }
